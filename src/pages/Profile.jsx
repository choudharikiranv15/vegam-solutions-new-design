...
export default function Profile() {
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-5xl mx-auto">
            {/* Header / Banner */}
            <div className="relative h-48 md:h-64 rounded-3xl overflow-hidden bg-gradient-to-r from-brand-600 to-purple-600">
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1579546929518-9e396f3cc809?q=80&w=2070&auto=format&fit=crop')] opacity-20 bg-cover bg-center"></div>
            ...
            <div className="flex flex-col md:flex-row gap-8 px-4 -mt-20 relative z-10">
                ...
                <div className="w-full md:w-80 shrink-0 space-y-6">
                    <Card className="flex flex-col items-center pt-0 overflow-visible relative">
                ...
                <div className="flex-1 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                            ...
                            <div className="md:col-span-2 space-y-2">
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-2.5 rounded-xl border border-brand-200 dark:border-brand-700 bg-transparent text-brand-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-500/20 disabled:opacity-50 disabled:bg-brand-50/50 resize-none"
                                />
                            </div>
                        </div>
                    </Card>
                    ...
                    <Card title="Security & Login">
                        <div className="space-y-4 items-center">
                            <div className="flex items-center justify-between p-4 rounded-xl border border-brand-100 dark:border-brand-800 bg-brand-50/30">
                                ...
                                <button className="px-3 py-1.5 text-sm font-medium text-emerald-600 bg-emerald-50 rounded-lg">Enabled</button>
                            </div>
                            ...
                            <div className="flex items-center justify-between p-4 rounded-xl border border-brand-100 dark:border-brand-800 bg-brand-50/30">
                                ...
                                <button className="px-3 py-1.5 text-sm font-medium text-brand-600 hover:text-brand-800">View All</button>
                            </div>
                        </div>
                    </Card>
                </div>
